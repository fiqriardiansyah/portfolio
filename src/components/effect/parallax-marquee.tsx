...
function ParallaxMarquee({ children, baseVelocity = 100, speed = 1000 }: ParallaxProps) {
   ...
   */
  return (
    <div className="flex flex-nowrap overflow-x-hidden overflow-y-visible whitespace-nowrap">

    ...
    <div className="w-screen overflow-x-hidden">
      ...
      <div className="CONTAINER">
        <div className="flex min-h-[100vh] flex-col items-center justify-center">
          ...
          >
            <motion.img src="/me.png" alt="fiqri ardiansyah" className="w-[80%] object-cover" />
            <motion.img src="/me.png" alt="fiqri ardiansyah" className="absolute w-[70%] object-cover" />
            <motion.img src="/me.png" alt="fiqri ardiansyah" className="absolute w-[60%] object-cover" />
          </motion.div>
